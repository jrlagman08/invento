        ...
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            ...
            <form id="UpdateForm" action="data/prod_update_data.php" method="post">
              <div class="modal-header">
                <h4 class="modal-title">Update Repackage</h4>
      ...
      <div class="modal fade" id="modal-default-view">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
              ...
              <div class="modal-header">
                <h4 class="modal-title">View Repackage</h4>
              ...
              <div class="modal-footer justify-content-between">
                ...
                <button type="button" id="viewID" class="btn btn-primary updateItem" data-id="" data-toggle="modal" data-target="#modal-default-update" data-dismiss="modal">Update Repackage</button>
              </div>
	...
	$("#UpdateForm").submit(function(){
		...
		$.post( $("#UpdateForm").attr("action"), $("#UpdateForm :input").serializeArray(), function(result){
			if (result == 'Success'){
				...
				successNotifNoload("Repackage Product successfully updated!");
			}
			else {
				errorNotifNoload(result);
			}
