          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  <button type="button" class="btn btn-block btn-success btn-sm" data-toggle="modal" data-target="#modal-default-add"><i class="fas fa-plus"></i> &nbsp;Add Supplier</button>
                </h3>
              </div>
              <!-- /.card-header -->
                    ...
                    <div class="card">
                      <div class="card-header">
                        ...
                        <div class="row">
                          <div class="col-sm-5">
                            <div class="form-group">
                              <input type="text" id="addProdCode" class="form-control" placeholder="Enter product code">
                            </div>
                          </div>
                          <div class="col-sm-5">
                            <div class="form-group">
                              <input id="addProdName" type="text" class="form-control" placeholder="Enter product name">
                            </div>
                          </div>
                          <div class="col-sm-2">
                            <div class="form-group">
                              <button type="button" class="btn btn-block btn-success" id="addProd">Add Product</button>
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-sm-5">
                            <div class="form-group">
                              <input type="text" id="addProdDetails" class="form-control" placeholder="Enter product details">
                            </div>
                          </div>
                          <div class="col-sm-5">
                            <div class="form-group">
                              <input type="text" id="addOrigPrice" class="form-control" onKeyPress="if(this.value.length==7) return false;" placeholder="Enter original price">
                            </div>
                          </div>
                      </div>
                      </div>
