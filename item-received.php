          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  <button type="button" id="additemrcvBtn" name="additemrcvBtn" class="btn btn-block btn-success btn-sm" data-toggle="modal" data-target="#modal-default-add"><i class="fas fa-plus"></i> &nbsp;Add Item Received</button>
                </h3>
              </div>
              <!-- /.card-header -->
                ...
                <div class="row">
				 <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="addRcvDate" name="addRcvDate" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input" id="addInvDateInput" name="addInvDateInput" data-target="#addRcvDate" placeholder="Select date & time" required/>
                        <div class="input-group-append" data-target="#addRcvDate" data-toggle="datetimepicker">
                    ...
                    <div class="card card-primary">
                      ...
                      <div class="card-body">
							...
							<div class="row">
							  ...
							  <div class="col-sm-3">
							    <label>Received Quantity <span class="req">*</span></label>
								<div class="form-group">
                ...
                <div class="row">
				 <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="updateRcvDate" name="updateRcvDate" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input" id="updateInvDateInput" name="updateInvDateInput" data-target="#updateRcvDate" placeholder="Select date & time" required/>
                        <div class="input-group-append" data-target="#updateRcvDate" data-toggle="datetimepicker">
                            <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                        </div>
                      </div>
                    </div>
...
$(document).ready(function() {
    ...
    $('#addRcvDate').datetimepicker({ icons: { time: 'far fa-clock' } });
    $('#updateRcvDate').datetimepicker({ icons: { time: 'far fa-clock' } });
	
	//--- Load data to table ---//
	function loadData(){
		$.post( "data/rcvitem_load_data.php", function(result,status){
			table.clear();
			var postStatus = "";
			var showCTRL = "";
			var obj = JSON.parse(result);
			 obj.forEach(function(item) {
				if (item.isPosted == true){
					...
					showCTRL = "<div class='btn-group btn-group-sm'><a href='#' class='btn btn-info viewItem' data-id="+item.receivedID+" data-toggle='modal' data-target='#modal-default-view' title='View'><i class='fas fa-eye'></i></a><a href='#' class='btn btn-danger deleteItem' data-id="+item.receivedID+" title='Delete'><i class='fas fa-trash'></i></a></div>";
				} else {
					postStatus = "<span style='color: red; font-weight: bold;'>No</span>";
					showCTRL = "<div class='btn-group btn-group-sm'><a href='#' class='btn btn-info viewItem' data-id="+item.receivedID+" data-toggle='modal' data-target='#modal-default-view' title='View'><i class='fas fa-eye'></i></a><a href='#' class='btn btn-warning updateItem' data-id="+item.receivedID+" data-toggle='modal' data-target='#modal-default-update' title='Update'><i class='fas fa-pen'></i></a><a href='#' class='btn btn-danger deleteItem' data-id="+item.receivedID+" title='Delete'><i class='fas fa-trash'></i></a></div>";
				}
				table.row.add([
					new Date(item.receivedDate).toLocaleDateString('en-us', {month: '2-digit', day: '2-digit', year: 'numeric', hour: 'numeric', minute: '2-digit'}).replace(/,/g, ""), 
					"", 
                    item.notes,
					postStatus,
					item.uname, 
